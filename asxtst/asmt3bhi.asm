...
abcdabcd::				; global symbol
	...
	.sbttl	Assembler Output File asmt3b_.sym


;       assembled by:
;                asxxxx -gloxff asmt3b_.asm
;
;Symbol Table
;
;    .__.ABS.       =   000000 G   |     AreaB              ****** GX
;    OVR                ****** GX  |   2 a0                 000000 GR
;    a1                 ****** GX  |     a2                 ****** GX
;  3 abcdabcd           00004A GR  |   1 byte3              000098 GR
;    cnstnt0        =   00ABCD G   |     cnstnt1        =   001234 G
;    cnstnt2        =   005678 G   |   1 code0              000218 GR
;    extern             ****** GX  |   1 lclsym0            00019A GR
;  1 lclsym1            0001D6 GR  |     m              =   000000 G
;    n              =   000001 G   |     n0x00          =   000000 G
;    n0x01          =   000001 G   |     n0x10          =   000010 G
;    n0xeeff        =   00EEFF G   |     n0xff          =   0000FF G
;    ofsbyte        =   000014 G   |     ofsword        =   00000A G
;  1 word               000090 GR
;
;Area Table
;
