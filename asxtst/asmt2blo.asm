...
;    a1                  ******** GX  |     a2                  ******** GX
;  3 abcdabcd            0000004A GR  |     cnstnt0        =    0000ABCD G
;    cnstnt1        =    00001234 G   |     cnstnt2        =    00005678 G
;  1 code0               0000020C GR  |     extern              ******** GX
;  1 lclsym0             0000018E GR  |   1 lclsym1             000001CA GR
...
;    ofsword        =    0000000A G   |   1 word                00000090 GR
;
; area table
;
;[_CSEG]
