...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\ez80adr.OBJ  $(OUTPUTDIR)\ez80ext.OBJ  \
...
$(OUTPUTDIR)\ez80ext.OBJ:	..\..\..\ASEZ80\ez80ext.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez80ext.obj ..\..\..\ASEZ80\ez80ext.c
