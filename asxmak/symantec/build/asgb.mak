...
HEADERS		= F:\SC\INCLUDE\stdio.h F:\SC\INCLUDE\setjmp.h ..\..\..\asxxsrc\asxxxx.h  \
		..\..\..\ASGB\gb.h F:\SC\INCLUDE\string.h F:\SC\INCLUDE\alloc.h F:\SC\INCLUDE\stdlib.h 
...
OBJS		=  $(OUTPUTDIR)\ASDATA.OBJ  $(OUTPUTDIR)\ASEXPR.OBJ  $(OUTPUTDIR)\ASLEX.OBJ  \
		 ...
		 $(OUTPUTDIR)\ASSYM.OBJ  $(OUTPUTDIR)\GBADR.OBJ  $(OUTPUTDIR)\GBEXT.OBJ  $(OUTPUTDIR)\GBMCH.OBJ  \
		 $(OUTPUTDIR)\GBPST.OBJ 
...
$(OUTPUTDIR)\GBEXT.OBJ:	..\..\..\ASGB\GBEXT.C
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\GBEXT.obj ..\..\..\ASGB\GBEXT.C
