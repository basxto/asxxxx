...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h ..\..\..\ASRAB\rab.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\alloc.h C:\SC\INCLUDE\stdlib.h 
...
INCLUDES	= -Ir:\asxv4pxx\asxxsrc -Ir:\asxv4pxx\asrab
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\rabadr.OBJ  $(OUTPUTDIR)\rabext.OBJ  \
...
$(OUTPUTDIR)\rabext.OBJ:	..\..\..\ASRAB\rabext.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rabext.obj ..\..\..\ASRAB\rabext.c
