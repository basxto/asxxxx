	...
	;
	; * is an optional prefix for labels within the first
	;   256 bytes of the address space.  (This is equivalent to
	;   PAG0 mode for AS68xx assemblers).  This prefix causes
	...
	;   mode will check for addresses within the first 256 bytes
	;   at assembly or link time.
	;

	mov	@value,r7	;  6B 07s00r00 (external global variable)
	mov	value,r7	;  6B 07s00r00
	mov	*@value,r7	;  6B 07s00r00 (mov.w has no @aa:8 mode)
	mov	*value,r7	;  6B 07s00r00
...
begin:	bf	1$		;  41 06
	mov	data,r0L	;  6A 08sXXrXX
	mov	*exdata,r0H	;  20*00
1$:	bra	begin		;  40 F6
	mov	data,r1L	;  6A 09sXXrXX
...
data:	.byte	0x10		;  10
	...
	xor.b	#xx08,r0L	;  D8 5A
	xor.b	r0L,r1L		;  15 89
	xor.b	#xx08,ccr	;  05 5A
	...
	and.b	#xx08,r0L	;  E8 5A
	and.b	r0L,r1L		;  16 89
	and.b	#xx08,ccr	;  06 5A
...
;	mov	@sp+,spL	;  6C 7F (illegal)
	...
	mov	r0H,@-r0	;  68 80
	mov	r7H,@-r0	;  68 87
;	mov	r0L,@-r7	;  68 F8 (illegal)
;	mov	r7L,@-r7	;  68 FF (illegal)

	mov	spH,@-r0	;  68 87
;	mov	spL,@-sp	;  68 FF (illegal)
